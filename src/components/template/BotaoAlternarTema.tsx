import { IconMoom, IconSun } from "../icons";
...
export default function BotaoAlternarTema(props: BotaoAlternarTemaProps) {
  return props.tema === "dark" ? (
    <div
      ...
      className="bg-gradient-to-r from-yellow-300 to-yellow-600 w-14 lg:w-24 h-8 sm:flex items-center hidden cursor-pointer p-1 rounded-full"
    >
    ...
    <div
      onClick={props.alternarTema}
      className="bg-gradient-to-r from-gray-600 to-gray-900 w-14 lg:w-24 h-8 sm:flex justify-end items-center hidden cursor-pointer p-1 rounded-full"
    >
